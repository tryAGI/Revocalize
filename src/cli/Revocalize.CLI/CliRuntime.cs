...
internal static class CliRuntime
{
    ...
    public static async Task<global::Revocalize.RevocalizeClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
    ...
    private static async Task WriteApiExceptionAsync(global::Revocalize.ApiException exception)
    {
        var builder = new StringBuilder();
