...
namespace Revocalize.CLI;

internal static class CliRuntime
{
    private const string UserSecretsId = "Revocalize.CLI";
    private const string UserSecretApiKeyName = "REVOCALIZE_API_KEY";
    private static readonly string[] ApiKeyEnvironmentVariables = [@"REVOCALIZE_API_KEY"];
    private const string CredentialFileDirectoryName = ".revocalize";

    public static async global::System.Threading.Tasks.Task<global::Revocalize.RevocalizeClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
        ...
        var authorizations = string.IsNullOrWhiteSpace(apiKey)
            ? new global::System.Collections.Generic.List<global::Revocalize.EndPointAuthorization>()
            : new global::System.Collections.Generic.List<global::Revocalize.EndPointAuthorization>
            {
        CreateAuthorization(
            type: "Http",
        ...
        return new global::Revocalize.RevocalizeClient(
            httpClient: null,
            baseUri: baseUri,
    ...
    private static global::Revocalize.EndPointAuthorization CreateAuthorization(
        string type,
        string schemeId,
        string location,
        string name,
        string value)
    {
        var authorization = new global::Revocalize.EndPointAuthorization
        {
            Type = type,
            Location = location,
            Name = name,
        ...
        var schemeIdProperty = typeof(global::Revocalize.EndPointAuthorization).GetProperty("SchemeId");
    ...
    public static async global::System.Threading.Tasks.Task<int> RunAsync(Func<global::System.Threading.Tasks.Task> action, CancellationToken cancellationToken = default)
    {
        ...
        catch (global::Revocalize.ApiException exception)
        {
    ...
    private static Uri? ResolveBaseUri(ParseResult parseResult)
    {
        ...
        {
            baseUrl = Environment.GetEnvironmentVariable("REVOCALIZE_BASE_URL");
        }
    ...
    private static async global::System.Threading.Tasks.Task WriteApiExceptionAsync(global::Revocalize.ApiException exception)
    {
        var builder = new StringBuilder();
