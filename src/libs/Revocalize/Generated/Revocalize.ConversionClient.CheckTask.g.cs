...
namespace Revocalize
{
    public partial class ConversionClient
    {
        ...
        private static readonly global::Revocalize.EndPointSecurityRequirement s_CheckTaskSecurityRequirement0 =
        ...
        private static readonly global::Revocalize.EndPointSecurityRequirement[] s_CheckTaskSecurityRequirements =
            new global::Revocalize.EndPointSecurityRequirement[]
            {                s_CheckTaskSecurityRequirement0,
            };
        partial void PrepareCheckTaskArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string taskId);
        partial void PrepareCheckTaskRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string taskId);
        partial void ProcessCheckTaskResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCheckTaskResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Revocalize.TaskStatusResponse> CheckTaskAsync(
            string taskId,
            global::Revocalize.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CheckTaskAsResponseAsync(
                taskId: taskId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Revocalize.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Revocalize.AutoSDKHttpResponse<global::Revocalize.TaskStatusResponse>> CheckTaskAsResponseAsync(
            string taskId,
            global::Revocalize.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Revocalize.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CheckTaskSecurityRequirements,
                operationName: "CheckTaskAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Revocalize.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Revocalize.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CheckTaskAsync",
                                pathTemplate: "$\"/check-task/{taskId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Revocalize.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCheckTaskResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Revocalize.TaskStatusResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Revocalize.AutoSDKHttpResponse<global::Revocalize.TaskStatusResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Revocalize.TaskStatusResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
