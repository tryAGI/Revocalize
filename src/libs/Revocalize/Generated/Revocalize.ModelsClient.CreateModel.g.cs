...
namespace Revocalize
{
    public partial class ModelsClient
    {
        ...
        private static readonly global::Revocalize.EndPointSecurityRequirement s_CreateModelSecurityRequirement0 =
        ...
        private static readonly global::Revocalize.EndPointSecurityRequirement[] s_CreateModelSecurityRequirements =
            new global::Revocalize.EndPointSecurityRequirement[]
        ...
        public async global::System.Threading.Tasks.Task<global::Revocalize.CreateModelResponse> CreateModelAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Revocalize.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Revocalize.AutoSDKHttpResponse<global::Revocalize.CreateModelResponse>> CreateModelAsResponseAsync(
            ...
            foreach (var __authorization in __authorizations)
            {
                         ...
                         __authorization.Location == "Header")
                {
                    __httpRequest.Headers.Add(__authorization.Name, __authorization.Value);
                            ...
                            var __contentTrainingAudioFiles = new global::System.Net.Http.ByteArrayContent(request.TrainingAudioFiles ?? global::System.Array.Empty<byte>());
                            __contentTrainingAudioFiles.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue(
                                request.TrainingAudioFilesname is null
                                    ? "application/octet-stream"
                                    : (global::System.IO.Path.GetExtension(request.TrainingAudioFilesname) ?? string.Empty).ToLowerInvariant() switch
                                    {
                                        ".aac" => "audio/aac",
                                        ".flac" => "audio/flac",
                                        ".gif" => "image/gif",
                            ...
                            __httpRequestContent.Add(
                                content: __contentTrainingAudioFiles,
                                name: "\"training_audio_files\"",
                                fileName: request.TrainingAudioFilesname != null ? $"\"{request.TrainingAudioFilesname}\"" : string.Empty);
                            if (__contentTrainingAudioFiles.Headers.ContentDisposition != null)
                            {
                                __contentTrainingAudioFiles.Headers.ContentDisposition.FileNameStar = null;
                            }
                    ...
                    await global::Revocalize.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Revocalize.CreateModelResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Revocalize.AutoSDKHttpResponse<global::Revocalize.CreateModelResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Revocalize.CreateModelResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Revocalize.CreateModelResponse> CreateModelAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Revocalize.CreateModelRequest
            {
        ...
        /// <exception cref="global::Revocalize.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Revocalize.CreateModelResponse> CreateModelAsync(
            global::System.IO.Stream trainingAudioFiles,
            string trainingAudioFilesname,
            global::Revocalize.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {

            trainingAudioFiles = trainingAudioFiles ?? throw new global::System.ArgumentNullException(nameof(trainingAudioFiles));
            var request = new global::Revocalize.CreateModelRequest
            {
                TrainingAudioFiles = global::System.Array.Empty<byte>(),
                TrainingAudioFilesname = trainingAudioFilesname,
            };
            PrepareArguments(
                client: HttpClient);
            ...
            foreach (var __authorization in __authorizations)
            {
                         ...
                         __authorization.Location == "Header")
                {
                    __httpRequest.Headers.Add(__authorization.Name, __authorization.Value);
                            ...
                            var __httpRequestContent = new global::System.Net.Http.MultipartFormDataContent();
                            var __contentTrainingAudioFiles = new global::System.Net.Http.StreamContent(trainingAudioFiles);
                            __contentTrainingAudioFiles.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue(
                                request.TrainingAudioFilesname is null
                                    ? "application/octet-stream"
                                    : (global::System.IO.Path.GetExtension(request.TrainingAudioFilesname) ?? string.Empty).ToLowerInvariant() switch
                    ...
                    await global::Revocalize.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::Revocalize.CreateModelResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                }
                                catch (global::System.Exception __ex)
                                {
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::Revocalize.CreateModelResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
                                        throw new global::System.InvalidOperationException("Response deserialization failed.");
                                }
                                catch (global::System.Exception __ex)
                                {
