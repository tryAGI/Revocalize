...
namespace Revocalize
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Revocalize.AutoSDKRetryOptions Retry { get; set; } = new global::Revocalize.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Revocalize.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Revocalize.IAutoSDKHook>();
        ...
        public global::Revocalize.AutoSDKClientOptions AddHook(
            global::Revocalize.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Revocalize.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Revocalize.AutoSDKClientOptions UseAuthorizationProvider(
            global::Revocalize.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Revocalize.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Revocalize.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Revocalize.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Revocalize.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Revocalize.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Revocalize.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Revocalize.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Revocalize.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Revocalize.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Revocalize.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Revocalize.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Revocalize.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Revocalize.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Revocalize.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Revocalize.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Revocalize.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Revocalize.AutoSDKClientOptions clientOptions,
            global::Revocalize.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Revocalize.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Revocalize.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Revocalize.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Revocalize.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Revocalize.IAutoSDKHook, global::Revocalize.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Revocalize.AutoSDKHookContext context)
        {
