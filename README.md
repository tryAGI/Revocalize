<div class="docs-hero">
  <h1>Revocalize</h1>
  <p class="docs-hero-lead">Modern .NET SDK for Revocalize generated from the provider's OpenAPI definition with AutoSDK.</p>
  <div class="docs-badge-row">
    <a href="https://www.nuget.org/packages/Revocalize/"><img alt="Nuget package" src="https://img.shields.io/nuget/vpre/Revocalize"></a>
    <a href="https://github.com/tryAGI/Revocalize/actions/workflows/dotnet.yml"><img alt="dotnet" src="https://github.com/tryAGI/Revocalize/actions/workflows/dotnet.yml/badge.svg?branch=main"></a>
    <a href="https://github.com/tryAGI/Revocalize/blob/main/LICENSE.txt"><img alt="License: MIT" src="https://img.shields.io/github/license/tryAGI/Revocalize"></a>
...
<div class="docs-feature-grid">
  <div class="docs-feature-card">
    ...
    <p>Built from a focused OpenAPI definition derived from <a href="https://docs.revocalize.ai/">Revocalize's published API documentation</a> so the SDK stays close to the upstream API surface.</p>
  </div>
  <div class="docs-feature-card">
    <h3>Auto-updated</h3>
...
<div class="docs-card-grid">
  <div class="docs-card">
    <h3>Bugs</h3>
    <p>Open an issue in <a href="https://github.com/tryAGI/Revocalize/issues">tryAGI/Revocalize</a>.</p>
  </div>
  <div class="docs-card">
    <h3>Ideas and questions</h3>
    <p>Use <a href="https://github.com/tryAGI/Revocalize/discussions">GitHub Discussions</a> for design questions and usage help.</p>
  </div>
  <div class="docs-card">
    <h3>Community</h3>
