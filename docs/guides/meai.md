...
The Revocalize SDK provides integration with [Microsoft.Extensions.AI](https://learn.microsoft.com/en-us/dotnet/ai/microsoft-extensions-ai), enabling seamless interoperability with the unified .NET AI abstractions.

## Installation

```bash
dotnet add package Revocalize
```
...
using var client = new RevocalizeClient(
    apiKey: Environment.GetEnvironmentVariable("REVOCALIZE_API_KEY")!);
